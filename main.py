...
def create_tablet_chart(df, name):
    ...
    fig.add_trace(go.Candlestick(
        ...
        increasing=dict(line=dict(color='#ff3366', width=1), fillcolor='#ff3366'),
    ...
    if len(strong_buy) > 0:
        fig.add_trace(go.Scatter(
            ...
            mode='markers',
            marker=dict(symbol='triangle-up', size=20, color='#ff003c',
    ...
    if len(sell) > 0:
        fig.add_trace(go.Scatter(
            ...
            y=sell['Sell_Signal'],
            mode='markers',
            marker=dict(symbol='triangle-down', size=16, color='#7b2ff7'),
            name='매도',
            showlegend=False
        ), row=1, col=1)
    ...
    # 과매도/과매수 라인
    fig.add_hline(y=OVERBOUGHT, line_dash="dot", line_color="#ff3366", 
                  opacity=0.5, row=2, col=1)
    fig.add_hline(y=OVERSOLD, line_dash="dot", line_color="#00ff64", 
                  opacity=0.5, row=2, col=1)
...
if 'all_stocks' in st.session_state:
    ...
    with col_chart:
        st.markdown("""
        <div style='background: rgba(15,15,25,0.5); border-radius: 20px; padding: 10px; 
        ...
        <div style='display: flex; justify-content: center; gap: 30px; margin-top: 10px;'>
            <span style='color: #00d4ff; font-size: 14px;'>━ %K</span>
            <span style='color: #ff8c00; font-size: 14px;'>━ %D</span>
            <span style='color: #00ff64; font-size: 14px;'>┈ 25</span>
            <span style='color: #ff3366; font-size: 14px;'>┈ 75</span>
        </div>
        """, unsafe_allow_html=True)
